...
// Funções específicas para cada tipo de toast, para facilitar o uso
...
export { 
  useToast, 
  toast,
  successToast as toastSuccess,
  errorToast as toastError,
  warningToast as toastWarning,
  infoToast as toastInfo
}
